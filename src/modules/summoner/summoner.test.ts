...
describe('SummonerAPI (Unit)', () => {
    ...
    it('should lazily fetch account data when fetchAccount is called', async () => {
        ...
        const mockAccount = new RiotAccount(sdk, { puuid: 'p-123', gameName: 'Ivan', tagLine: 'T' }, 'europe', Date.now());
    ...
    it('should prevent circular references in toJSON', () => {
        ...
        const summoner = new RiotSummoner(sdk, { puuid: 'p-1', summonerLevel: 100 } as any, 'euw1', Date.now(), account);
